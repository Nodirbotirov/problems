...
import collection.flowbosConverter.exceptions.*;
import collection.flowbosConverter.types.Parity;
import collection.flowbosConverter.types.RegisterOrder;
import collection.flowbosConverter.types.StopBits;
...
//    }
    ...
    public static int[] ConvertDoubleToRegisters(int doubleValue) {
        byte[] doubleBytes = toByteArrayDouble(doubleValue);
    ...
    public static int[] ConvertDoubleToRegisters(int doubleValue, RegisterOrder registerOrder) {
        int[] registerValues = ConvertFloatToRegisters((float) doubleValue);
        int[] returnValue = registerValues;
        if (registerOrder == RegisterOrder.HighLow) {
            returnValue = new int[]{registerValues[1], registerValues[0]};
        }
